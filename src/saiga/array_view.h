...
//    using size_type = size_t;
    ...
    HD reference operator[](size_t id) const{
        //			if(id >= n) {
        ...
        HD const_reference back() const {
        return data_[n-1];
    }


        HD pointer data() const {
        return data_;
    }
        ...
        HD size_type byte_size() const {
        return sizeof(T) * n;
    }

        HD iterator begin() const {
        return data_;
    }

        HD iterator end() const {
        return data_+n;
    }
